...
//
$mail_sys = "fighting.fist@me.com";	// 管理者のメールアドレス
$from_name = "山本順貴";	// メール送信者の表示
$from_mail = "fighting.fist@me.com";	// メール送信者のメールアドレス（返信先）
$user_mail = "item2";	// 利用者にメールを送る場合のメールアドレス項目
//---
$title = "お問い合わせフォーム";
$subject = "お問い合わせありがとうございます。\n";
$body = "お問い合わせありがとうございます。以下の内容で承りました。\n";
$subject_sys = "お問い合わせがありました。\n";
$body_sys = "以下のお問い合わせがありました。\n";
$footer = "\n
fighting.fist@me.com";
//------------------------------------------------
